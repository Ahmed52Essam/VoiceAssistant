...
from commands import CopyCommand
...
class TestCopyCommand(unittest.TestCase):
    ...
    def test_match_expected_command(self):
        self.assertTrue(self.command.match("copy text"))

    def test_match_invalid_command(self):
        self.assertFalse(self.command.match("paste clipboard"))

    def test_execute(self):
        result = self.command.execute("copy text", self.tts, self.recognizer)
